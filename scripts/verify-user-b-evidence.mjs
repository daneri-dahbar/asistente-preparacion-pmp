...
const sortedDates = dateValues.map((item) => new Date(item.value)).sort((a, b) => a - b);
...
console.log(JSON.stringify({
  ...
  dateCheck: {
    ...
    firstDate: sortedDates[0]?.toISOString() || null,
    lastDate: sortedDates.at(-1)?.toISOString() || null,
  },
}, null, 2));
