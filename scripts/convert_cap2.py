...
if __name__ == "__main__":
    ...
    input_md = r"c:\Proyectos\asistente-preparacion-pmp\docs\informe_final\CAPITULO-2.md"
    output_tex = r"c:\Proyectos\asistente-preparacion-pmp\docs\informe_final\CAPITULO-2.tex"
